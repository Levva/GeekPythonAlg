...
def main():
    s = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eleifend eleifend arcu a accumsan. Suspendisse id vulputate massa. Ut molestie.'  # читаем строку длиной  до 10**4
